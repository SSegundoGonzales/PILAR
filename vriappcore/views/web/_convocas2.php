...
<div class="container ">
 ...
 <div class="navbar navbar-default navbar-paginas">
    <div class="container">
       ...
       <div id="navbar" class="collapse navbar-collapse navbar-responsive-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="actual"><a href="#">VIGENTES</a></li>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-md-4 paddington30 bg-0">
     ...
     <br>
        ...
        <div class="col-xs-12 col-md-8 paddington30">
           <div class="listado" style="color:">
              <h1> TITULO</h1>
              ljndsalhfdlsafldsljhfs flksflsakdhflsa hflksjf lkdsajflkdsajf lkdsajflksadjflksadjflkdsjflkdsajflkdsjflka
